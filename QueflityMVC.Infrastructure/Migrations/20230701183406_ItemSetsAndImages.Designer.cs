...
namespace QueflityMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230701183406_ItemSetsAndImages")]
    partial class ItemSetsAndImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QueflityMVC.Domain.Models.Item", b =>
                {
                    ...
                    b.HasOne("QueflityMVC.Domain.Models.ItemSet", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("QueflityMVC.Domain.Models.ItemSet", b =>
                {
                    b.HasOne("QueflityMVC.Domain.Models.ItemSetImage", "ItemSetImage")
                        .WithOne("ItemSet")
                        .HasForeignKey("QueflityMVC.Domain.Models.ItemSet", "ItemSetImageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("ItemSetImage");
                });
