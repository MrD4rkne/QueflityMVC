        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kit_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasePurchasableEntity_BasePurchasableEntity_ItemId",
                        column: x => x.ItemId,
                        principalTable: "BasePurchasableEntity",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BasePurchasableEntity_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasePurchasableEntity_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SetElements_BasePurchasableEntity_ItemId",
                        column: x => x.ItemId,
                        principalTable: "BasePurchasableEntity",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SetElements_BasePurchasableEntity_KitId",
                        column: x => x.KitId,
                        principalTable: "BasePurchasableEntity",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasePurchasableEntity_CategoryId",
                table: "BasePurchasableEntity",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_BasePurchasableEntity_ImageId",
                table: "BasePurchasableEntity",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_BasePurchasableEntity_ItemId",
                table: "BasePurchasableEntity",
                column: "ItemId");
